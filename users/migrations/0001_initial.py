    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisines', multiselectfield.db.fields.MultiSelectField(choices=[('ITALIAN', 'Italian'), ('MEDITERRAENIAN', 'Mediterraenian'), ('ASIAN', 'Asian'), ('MEXICAN', 'Mexican'), ('MIDDLE_EASTERN', 'Middle Eastern'), ('AMERICAN', 'American'), ('FRENCH', 'French'), ('INDIAN', 'Indian'), ('AFRICAN', 'African')], max_length=50)),

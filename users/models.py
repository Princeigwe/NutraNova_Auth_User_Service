...
class CustomUser(AbstractUser):
  ...
  telephone           = models.CharField(max_length=15, default=00000000)
  gender              = models.CharField(max_length=30, choices=choices.GENDER_CHOICES, default="PREFER_NOT_TO_SAY")
  ...
  health_goal         = MultiSelectField(max_length=50, choices=choices.HEALTH_GOALS_CHOICES, default="OVERALL_WELLNESS")
